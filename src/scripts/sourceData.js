...
const client = contentful.createClient({
    space: '1usc8bssaj89', // Insert Contentful Space ID
    accessToken: '3lDwAtLDGf5O8ndvpzoin1LUgCEq4xXtXSJG_6plSow' // Insert Contentful Content Delivery API access token
});
